...
export const metadata = {
  title: 'SS Maintenance - Engineer Requests Management',
  description: 'SS Maintenance dashboard for managing customer maintenance requests and engineer assignments.'
}

...
const themeConfig: Config = {
  ...
  layoutPadding: 20, // X-Station Design Language: Screen padding 20px
  compactContentWidth: 1440, // in px
  navbar: {
    type: 'fixed', // 'fixed', 'static'
    contentWidth: 'compact', // 'compact', 'wide'
    floating: false, // Cleaner look
    detached: false, // Cleaner look
    blur: false // No unnecessary effects
  },
  contentWidth: 'compact', // 'compact', 'wide'
  footer: {
  ...
  disableRipple: true, // X-Station Design Language: No bounce, no spring, no delight animations
